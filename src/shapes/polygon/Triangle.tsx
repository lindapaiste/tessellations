...
/**
 * define the three sides of a triangle by properties height, width, skew
 * redefining the interface here for documentation purposes, even though it is the same as other shapes
 */
